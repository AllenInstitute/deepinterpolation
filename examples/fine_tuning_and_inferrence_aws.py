...
def main(argv):
    opts, args = getopt.getopt(
        argv, [], ["movie_path=", "input_data_generator=", "raw_model_path=", "output_path_training=", "fine_tune=", 'batch_size=', 'training_loss=', 'learning_rate=',
                   'steps_per_epoch=', 'save_raw=','pre_frame', 'post_frame', 'total_samples_for_training', 'total_samples_for_validation',
                   'multi_gpus', 'nb_times_training_through_data', 'frame_start_validation', 'frame_end_validation', 'frame_start_training,
                    'frame_end_training', 'frame_start_inferrence', 'frame_end_inferrence', 'output_file_inferrence    
                   ],
    )
    ...
    ] = nb_times_training_through_data  # if you want to cycle through the entire data. Two many iterations will cause noise overfitting
