...
generator_test_param["end_frame"] = 9999
generator_test_param[
    "pre_post_omission"
...
generator_param["start_frame"] = 10000
...
jobdir = os.path.join(
    "/Users/sk/documents/python/deepinterpolation/examples/test", training_param["model_string"] + "_" + run_uid,
)
