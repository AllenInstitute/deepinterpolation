...
folder_path = "/home/jeromel/Documents/Projects/Deep2P/repos/deepinterpolation/examples/multi_ophys/multi-gpu"
...
for indiv_file in os.listdir(folder_path):
    ...
    if "gpu_1" in python_file:
        nb_gpus = 1
    elif "gpu_2" in python_file:
        nb_gpus = 2
    elif "gpu_4" in python_file:
        nb_gpus = 4
