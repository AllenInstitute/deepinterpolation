...
def main(argv):
    ...
    python_file = (r"/home/jeromel/Documents/Projects/Deep2P/repos/" +
                   ...
                   r"cluster_lib/single_ophys_transfer_trainer.py")
    ...
    raw_data = h5py.File(dat_file, 'r')['data']
    img_per_movie = int(raw_data.shape[0])
    pre_post_frame = 30
    batch_size = 5
    nb_jobs = 100
    training_samples = -1
    start_frame = pre_post_frame
    end_frame = img_per_movie - pre_post_frame - 1
    ...
    python_file = (r"/home/jeromel/Documents/Projects/Deep2P/repos/" +
                   r"deepinterpolation/examples/paper_generation_code/" +
                   r"cluster_lib/single_ophys_section_inferrence.py")
