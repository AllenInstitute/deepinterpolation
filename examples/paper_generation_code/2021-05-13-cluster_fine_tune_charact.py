...
python_file = os.path.join(
    "/home/jeromel/Documents/Projects/Deep2P/repos/deepinterpolation/examples/paper_generation_code",
    "2021-05-13-fine_tune_tif_charact.py",
)
...
for indiv_id in list_exp_id:
    ...
    PythonJob(
        python_file,
        # "/home/jeromel/.conda/envs/deep_work_gpu/bin/python",
