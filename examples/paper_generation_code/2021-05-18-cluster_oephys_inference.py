...
output_path = r"/allen/programs/braintv/workgroups/neuralcoding/2p_data/"\
    "single_plane/2021-05-14-simulation-naomi/"
...
for indiv_id in list_exp_folder:
    try:
        ...
        jobdir = os.path.join(output_path, indiv_id, 'deepinterp', 'infer')
        ...
        raw_model = os.path.join(output_path, indiv_id, 'deepinterp',
                                 "*_model.h5")
